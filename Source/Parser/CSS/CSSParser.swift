...
//  SVGView
//
//  Created by Alisa Mylnikova on 03/12/2021.
//
...
class CSSParser {
    ...
    func getStyles(element: XMLElement) -> [String: String] {
        ...
        if let classNamesString = element.attributes["class"] {
        ...
        if let idString = element.attributes["id"] {
